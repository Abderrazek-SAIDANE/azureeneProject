            ...
            function (data) {
                ...
                for (var rowIdx = 1; rowIdx < csvData.length; rowIdx++) {
                    ...
                    for (var colIdx = 0; colIdx < csvData[rowIdx].length; colIdx++) {
                        ...
                        var $tableBodyRowTd = $("<td data-label='"+$tableHead[colIdx]+"></td>");

                        // Utilisation de templates personnalisés si disponibles
                        var cellTemplateFunc = customTemplates[colIdx];
                        if (cellTemplateFunc) {
                            $tableBodyRowTd.append($("<td data-label='"+$tableHead[colIdx]+"'></td>")).html(cellTemplateFunc("css/images/"+csvData[rowIdx][colIdx+1]+".jpg", rowIdx, colIdx));
                        } else {
